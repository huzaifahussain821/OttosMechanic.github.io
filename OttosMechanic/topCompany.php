...
<ul class="navbar-nav mr-auto navbar-fixed-top.scrolled"> </ul>
   ...
   <div class="container-fuild" style="z-index: -1;margin-top: 0px !important ;background-image: url(imgs/Service-bg.jpg); height: auto;background-size: cover;width: 100%; padding: 5%;">
        <div class="container" style="text-align: center;">
            <br><br><br><br><br>
            <h1 style="color: #36f182;">Book a Full Car Service Near You</h1>
   ...
   <div class="container-fluid">
        <div class="row" style="padding: 10px; background-color: rgb(51, 51, 51); text-align: center; justify-content:space-between;">
            <div class="col-12 col-sm-12 col-md-3">
                <h3 style="color: #36f182;">2,602 Quotes</h3>
                <br>
            ...
            <div class="col-12 col-sm-12 col-md-3">
                <h3 style="color: #36f182;">£ 62.22</h3>
                <br>
            ...
            <div class="col-12 col-sm-12 col-md-3">
                <h3 style="color: #36f182;">33 minutes</h3>
                <br>
        ...
        <div class="container-fluid">
            ...
            <div class="row">
                <div class="col-12 col-sm-12 col-md-6">
                    ...
                    <button class="btn btn-default vpBtn" style="width: 100%; height: 70px; font-size: 14px; font-weight: 500; background-color: white; box-shadow: 0px 2px 2px 1px silver;">View profile</button>
                </a></div>
                
                <div class="col-12 col-sm-12 col-md-6"> 
                    <a href="reqQuote.html">
                    <button class="btn btn-success rqBtn" style="width: 100%; height: 70px; font-size: 14px; font-weight: 500; background-color: #36f182;border:0px; color: black;">Request a Quote</button>
                </a>
                </div>
            </div>
            <br>
...
<br><p style="text-align: justify;">
    ...
    Below are average quotes, split by car make on WhoCanFixMyCar.com for mobile services. However, 
