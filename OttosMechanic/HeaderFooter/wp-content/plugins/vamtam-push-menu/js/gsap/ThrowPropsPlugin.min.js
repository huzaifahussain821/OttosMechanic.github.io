...
(_gsScope._gsQueue || (_gsScope._gsQueue = [])).push(function() {
        ...
        _gsScope._gsDefine("plugins.ThrowPropsPlugin", ["plugins.TweenPlugin", "TweenLite", "easing.Ease", "utils.VelocityTracker"], function(a, b, c, d) {
            var e, f, g, h, i = function(b, c) {
                ...
                o = function(a, b, c, d) {
                    for (var e, f, g = b.length, h = 0, i = j; --g > -1;) e = b[g], f = e - a, 0 > f && (f = -f), i > f && e >= d && c >= e && (h = g, i = f);
                    return b[h]
                },
                p = function(a, b, c, d) {
                    if ("auto" === a.end) return a;
                    c = isNaN(c) ? j : c, d = isNaN(d) ? -j : d;
                    var e = "function" == typeof a.end ? a.end(b) : a.end instanceof Array ? o(b, a.end, c, d) : Number(a.end);
            ...
            return u.constructor = i, i.version = "0.10.0", i.API = 2, i._autoCSS = !0, i.defaultResistance = 100, i.defaultUnitFactors = {
                ...
                c.throwProps || (c = {
                    throwProps: c
                }), 0 === j && (c.throwProps.preventOvershoot = !0), m = !0;
                var k = new b(a, i || 1, c);
                return k.render(0, !0, !0), k.vars.css ? (k.duration(t(e, {
                    throwProps: f,
                    ease: c.ease
                }, d, i, j)), k._delay && !k.vars.immediateRender ? k.invalidate() : g._onInitTween(e, h, k), m = !1, k) : (k.kill(), k = new b(a, t(a, c, d, i, j), c), m = !1, k)
            }, u._onInitTween = function(a, b, c, e) {
                this.target = a, this._props = [], g = this, h = b;
                var f, i, j, k, l, n, o, s, t, u = c._ease,
                    v = isNaN(b.checkpoint) ? .05 : Number(b.checkpoint),
                    w = c._duration,
                    x = b.preventOvershoot,
                    y = 0;
                for (f in b)
                    if ("resistance" !== f && "checkpoint" !== f && "preventOvershoot" !== f) {
                        if (i = b[f], "function" == typeof i && (i = i(e, a)), "number" == typeof i) l = Number(i) || 0;
                        else if ("object" != typeof i || isNaN(i.velocity)) {
                            if (t = t || d.getByTarget(a), !t || !t.isTrackingProp(f)) throw "ERROR: No velocity was defined in the throwProps tween of " + a + " property: " + f;
                            l = t.getVelocity(f)
                        } else l = Number(i.velocity);
                        n = r(l, u, w, v), s = 0, k = "function" == typeof a[f], j = k ? a[f.indexOf("set") || "function" != typeof a["get" + f.substr(3)] ? f : "get" + f.substr(3)]() : a[f], "object" == typeof i && (o = j + n, void 0 !== i.end && (i = p(i, o, i.max, i.min), m && (b[f] = q(i, b[f], "end"))), void 0 !== i.max && Number(i.max) < o ? x || i.preventOvershoot ? n = i.max - j : s = i.max - j - n : void 0 !== i.min && Number(i.min) > o && (x || i.preventOvershoot ? n = i.min - j : s = i.min - j - n)), this._overwriteProps[y] = f, this._props[y++] = {
                            p: f,
                            s: j,
                            c1: n,
                            c2: s,
                ...
                for (var b, c = this._props, d = c.length; --d > -1;) b = a[c[d].p] || a.throwProps, "function" == typeof b && (c[d].m = b)
            }, u.setRatio = function(a) {
                for (var b, c, d = this._props.length; --d > -1;) b = this._props[d], c = b.s + b.c1 * a + b.c2 * a * a, b.m ? c = b.m(c, this.target) : 1 === a && (c = (1e4 * c + (0 > c ? -.5 : .5) | 0) / 1e4), b.f ? this.target[b.p](c) : this.target[b.p] = c
            }, a.activate([i]), i
            ...
            var b, c, d, e, f = /([A-Z])/g,
                ...
                m = function() {
                    ...
                    if (g - d >= .03)
                        for (e = d, d = g; f;) {
                            for (c = f._firstVP; c;) a = c.css ? j(f.target, c.p) : c.f ? f.target[c.p]() : f.target[c.p], (a !== c.v1 || g - c.t1 > .15) && (c.v2 = c.v1, c.v1 = a, c.t2 = c.t1, c.t1 = g), c = c._next;
                            f = f._next
                        }
                },
                n = function(a) {
            ...
            return p.addProp = function(b, c) {
                ...
                var b, c, d, e = this._lookup[a],
                    f = this.target;
                if (!e) throw "The velocity of " + a + " is not being tracked.";
                return b = e.css ? j(f, e.p) : e.f ? f[e.p]() : f[e.p], c = b - e.v2, ("rad" === e.type || "deg" === e.type) && (d = "rad" === e.type ? 2 * Math.PI : 360, c %= d, c !== c % (d / 2) && (c = 0 > c ? c + d : c - d)), c / (k.time - e.t2)
