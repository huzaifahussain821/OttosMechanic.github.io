        ...
        <div class="row">
            <div class="col-12">
                <nav class="navbar navbar-expand-lg navbar-tra
                    justify-content-between text-white fixed-top"
...
<ul class="navbar-nav mr-auto navbar-fixed-top.scrolled"> </ul>
                <ul class="navbar-nav navbar-fixed-top.scrolled ">
                    ...
                    <li class="nav-item dropdown">
                        ...
                        aria-expanded="false" class=" menulink navbar-fixed-top.scrolled " >
                         <b>Find Garages</b> &nbsp;<i class="fa fa-caret-down" aria-hidden="true"></i>
                        </a>
                        ...
                        <div class="row conPad">
                            <div class="col-12 col-sm-12 col-md-3 " >
                               ...
                               <a class="dropdown-item" href="mobileMechanic.html"style="display: flex; font-size:12px">
                             ...
                             <div class="col-12 col-sm-12 col-md-3">
                               <a class="dropdown-item" href="cambeltChange.html"style="display: flex; font-size:12px" > <img src="imgs/AllService/cambelt.svg" width="22px" alt="">
                             ...
                             <div class="col-12 col-sm-12 col-md-3">
                               <a class="dropdown-item" href="brake&Disc.html"style="display: flex; font-size:12px"> <img src="imgs/AllService/brake-pads-discs.svg" width="22px" alt="">
                             ...
                             <div class="col-12 col-sm-12 col-md-3">
                               <a class="dropdown-item" href="Aircon.html"style="display: flex; font-size:12px"> <img src="imgs/AllService/icon-heatingCooling.svg"width="22px">
                                 &nbsp;&nbsp;
                                Aircon Regas
                               </a> 
                            </div>
                         ...
                         <div class="row conPad">
                          <div class="col-12 col-sm-12 col-md-3">
                            <a class="dropdown-item" href="Diagnostic.html"style="display: flex; font-size:12px"> <img src="imgs/AllService/icon-diagnostics.svg" width="22px" alt="">
                             ...
                             <div class="col-12 col-sm-12 col-md-3">
                               <a class="dropdown-item" href="fullService.html"style="display: flex; font-size:12px"> <img src="imgs/AllService/full-service-icon.svg" width="22px" alt="">
                             ...
                             <div class="col-12 col-sm-12 col-md-3">
                               <a class="dropdown-item" href="OilChnage.html"style="display: flex; font-size:12px"> <img src="imgs/AllService/oil-change.svg" width="18px" alt="">
                             ...
                             <div class="col-12 col-sm-12 col-md-3">
                               <a class="dropdown-item" href="MobileTyreFitting.html"style="display: flex; font-size:12px"> <img src="imgs/AllService/mobile-mechanic.svg" width="22px" alt="">
                        ...
                        <div class="row conPad">
                          <div class="col-12 col-sm-12 col-md-3">
                            <a class="dropdown-item" href="shockAbsorber.html"style="display: flex; font-size:12px"> <img src="imgs/AllService/icon-heatingCooling.svg" width="22px" alt="">
                             ...
                             <div class="col-12 col-sm-12 col-md-3">
                               <a class="dropdown-item" href="turboFault.html"style="display: flex; font-size:12px"> <img src="imgs/AllService/icon-engineCooling.svg" width="22px" alt="">
                             ...
                             <div class="col-12 col-sm-12 col-md-3">
                               <a class="dropdown-item" href="ExhaustFitting.html"style="display: flex; font-size:12px"> <img src="imgs/AllService/exhaust-fitting.svg" width="22px" alt="">
                             ...
                             <div class="col-12 col-sm-12 col-md-3">
                               <a class="dropdown-item" href="bodyWork.html"style="display: flex; font-size:12px"> <img src="imgs/AllService/bodywork-dents.svg" width="22px" alt="">
                        ...
                        <div class="row conPad">
                          <div class="col-12 col-sm-12 col-md-3">
                            <a class="dropdown-item" href="MOT.html"style="display: flex; font-size:12px"> <img src="imgs/AllService/mot-icon.svg" width="22px" alt="">
   ...
   <div class="container-fuild" style="z-index: -1;margin-top: 0px !important ;background-image: url(imgs/Service-bg.jpg); height: auto;background-size: cover;width: 100%; padding: 5%;">
        <div class="container" style="text-align: center;">
            <br><br><br><br><br>
            <h1 style="color: #00b81f;">Book a Full Car Service Near You</h1>
            ...
            <div class="container">
                <div class="row">
                    ...
                    <div class="col-12 col-md-6 col-sm-12" style="margin-top: -2.3%;">
                        <div class="container">
                            <div class="row">
                              <div class="col mt-4">
                                ...
                                <div class="dropdown">    
                                    ...
                                    <button class="btn btn-default dropdown-toggle" style="width: 100% !important;height: 50px; background-color: white;font-size: 20px; text-align: left;" 
                                    type="button" 
                                    id="dropdownMenuButton" data-toggle="dropdown" aria-haspopup="true" aria-expande  d="false">Mobile Mechanic</button>                       
                                      <div class="dropdown-menu pre-scrollable" aria-labelledby="dropdownMenuButton" style="width: 100%;">                                                           
                                        <h3></h3>
                                        <input type="text" class="form-control" placeholder="search.." style="font-size: 14px;">                                 
                                       <a class="dropdown-item" href="allService.html">All Services</a>                          
                                       <a class="dropdown-item" href="mobileMechanic.html">Mobile Mechanic</a>
                                       <a class="dropdown-item" href="FullService&MOT.html">Servicing and MOT</a>
                                       <a class="dropdown-item" href="clutchReplacement.html">Clutch and Gearbox Repairs</a>
                                       <a class="dropdown-item" href="clutchReplacement.html">Clutch Repairs</a>
                                       <a class="dropdown-item" href="brake&Disc.html">Brake Repairs</a>                                        
                                       <a class="dropdown-item" href="mobileMechanic.html">Mobile Mechanics and Services</a>                                                
                                       <a class="dropdown-item" href="ExhaustFitting.html">Engine and Cooling</a>                                              
                                       <a class="dropdown-item" href="Aircon.html">Air-Con, Heating and Cooling</a>                                              
                                       <a class="dropdown-item" href="bodyWork.html">Bodywork, Dents and Smart Repairs</a>                                  
                                       <a class="dropdown-item" href="bodyWork.html">Breakdown and Recovery</a>                                               
                                        <a class="dropdown-item" href="Diagnostic.html">Diagnostics</a>                                        
                                        <a class="dropdown-item" href="electricalFault.html">Electrical and Batteries</a>        
                                        <a class="dropdown-item" href="electricalFault.html">Hybrid and Electric Vehicles</a>                                               
                ...
                <br><br> <a href="reqQuote.html">
                <button class="btn btn-default rqBtn" style="text-align: center !important;border-radius:10px; color:rgb(22, 17, 71);width: auto !important;height: 50px; background-color: #00b81f; font-weight: bold;
                font-size: 16px; text-align: left;" type="button" >GET QUOTES</button> 
            </a> 
                </div>
             </div>
            ...
            justify-content: space-between;">
                <div class="col-12 col-md-3 col-sm-12" style="text-align: center; min-height: 120px;">
                <img src="imgs/price-gaurantee-o.svg" width="150px">
                <h2 style="color:rgb(184, 181, 181); font-weight: 700;"> Price Guarantee</h2>
                <p style="color:rgb(184, 181, 181); font-size:20px;"> Our price match promise</p>
                
                </div>
                <div class="col-12 col-md-3 col-sm-12" style="text-align: center; min-height: 120px;">
                    <img src="imgs/ratings-4halfstar.svg" width="200px">
                    <h3 style="color:rgb(184, 181, 181); font-weight: 700;"> Best Local Garages</h3>
                    <p style="color:rgb(184, 181, 181); font-size:20px;"> 'Excellent' - 4.5/5 Trustpilot</p>
                    
                </div>
                <div class="col-12 col-md-3 col-sm-12" style="text-align: center; min-height: 120px;">
                    <img src="imgs/save-money-o.svg" width="150px">
                    <h3 style="color:rgb(184, 181, 181); font-weight: 700;"> Over 3 million</h3>
                    <p style="color:rgb(184, 181, 181); font-size:20px;">Average driver saving</p>
                    
                </div>
            </div>
            <br><br><br>
            <p style="color: white; font-size: 22px;">
            <a href="index.html">Home </a><i class="fa fa-chevron-right" aria-hidden="true"></i> <a href="#">All Repairs</a><i class="fa fa-chevron-right" aria-hidden="true"></i>  <a href="#">Mobile Mechanics</a>
            </p>
        </div>
   </div>
   <div class="container-fluid">
        <div class="row" style="padding: 10px; background-color: rgb(51, 51, 51); text-align: center; justify-content:space-between;">
            <div class="col-12 col-sm-12 col-md-3">
                <h3 style="color: #00b81f;">2,602 Quotes</h3>
                <br>
                <h5 style="color: white;">provided for All Service  work this month</h5>
                <h6 style="color: white;"><a href="#">show more </a><i class="fa fa-angle-down" aria-hidden="true"></i></h6>
            </div>
            <div class="col-12 col-sm-12 col-md-3">
                <h3 style="color: #00b81f;">£ 62.22</h3>
                <br>
                <h5 style="color: white;">average All Service price this month</h5>
                <h6 style="color: white;"><a href="#">see change over time  </a><i class="fa fa-angle-down" aria-hidden="true"></i></h6>
            </div>
            <div class="col-12 col-sm-12 col-md-3">
                <h3 style="color: #00b81f;">33 minutes</h3>
                <br>
                <h5 style="color: white;">since the last quote for All Service work</h5>
                <h6 style="color: white;"><a href="#">see last three quotes  </a><i class="fa fa-angle-down" aria-hidden="true"></i></h6>
            </div>
        </div>
    </div>
   </div>
...
<div class="container" style="text-align: center; padding: 2%">
    <p style="font-weight:700">Find Great Value Local Servicing, Car Repairs and Parts with OttosMechanic.</p>
...
<div class="row"  style="border: 1px solid silver;">
    <div class="col-12 col-sm-12 col-md-8" style="background-color:#F4F4F4;" >
        <div class="container-fluid">
            <div class="row">
                <div class="col-12 mt-3">
                    <div class="card"style="background-color:#F4F4F4;border: 0px">
                        <div class="card-horizontal">
                            <div class="img-square-wrapper">
                                <img class="" src="imgs/card2.png" alt="Card image cap" style="margin-top: 10%; margin-left: 5px;">
                            </div>
                            <div class="card-body">
                                <h4 class="card-title" ><a href="#"style="color: black !important;">Car Technic</a></h4>
                                <h6 class="card-text"><b>25 </b>Jobs Completed. <i class="fa fa-location-arrow" aria-hidden="true"></i> Mitcham
                                ...
                                <hr>
                                <p style="color: #808080; text-align:left ;">We are an independent Vehicle service station situated in Liongate Enterprise Park on Morden Road. Specialist is German and Japanese cars. Along with</p>
                            </div>
                        </div>
                    </div>
                </div>
        ...
        <div class="container-fluid">
            ...
            <div class="row">
                ...
                <div class="col-12 col-sm-12 col-md-6"> 
                    ...
                    <button class="btn btn-success rqBtn" style="width: 100%; height: 40px; font-size: 14px; font-weight: 500; background-color: #00b81f;border:0px; color: black;">Request a Quote</button>
                </a>
                </div>
            </div>
            <br>
            <div class="row" style="border: 0.5px solid silver;">
                <div class="col-12 col-sm-12 col-md-2">
                    <div class="smImg">
                    <img src="imgs/review.jpg" style="border-radius:10px ;">
                </div>
                </div>
                <div class="col-12 col-sm-12 col-md-10">
                    <p style="margin-bottom: 0px;"><b>Cris, Toyota Previa</b>on 31.05.21</p>
                    <p style="margin-top: 0px; margin-bottom: 10px;">Kind, courteous and professional. I would 100% recommended this garage</p>
                </div>
            </div>
...
<div class="container-fuild" style="background-image: url(imgs/Service-bg.jpg); height: auto;background-size: cover;width: 100%; padding: 5%;">
        <div class="container" style="text-align: center;">
            <br><br><br>
            <h1 style="color: #F4F4F4;">Find a Mobile Mechanic</h1>
            <br><h3 style="color: white;">
                Compare, Book, Repair.<b> Save.</b> 
            </h3>
            <br>
            </div>
            <div class="container fwCon" style="width: 40%;">
                <div class="row" style=" display: flex;
                justify-content: space-between;">
                    ...
                    <div class="col-12 col-md-6 col-sm-12">
                        <p style="color: white;  margin-bottom: 1px;">Get Quotes
                        </p>
                        <button class="btn btn-default rqBtn" style="text-align: center !important;border-radius:40px; color:white;width: 100% !important;height: 50px; background-color: #00b81f;
                        font-size: 20px; text-align: left;" type="button" id="dropdownMenuButton" data-toggle="dropdown" aria-haspopup="true" aria-expande  d="false">GET QUOTES</button>                       
...
<!-- TABLE -->
<br><br>
<h3><b>What is the cost to call out a mobile mechanic?</b></h3>
...
<br><p style="text-align: center;">
    ...
    <table>
        ...
        <tbody>
          <tr>
            <td data-column="Car Make">Vauxhall</td>
            <td data-column="Average Price">£60.91</td>
            <td data-column="Get Quotes"><button class="btn btn-success rqBtn" style="background-color: #4dbb0d;">Compare Quotes</button></td>
                   </tr>
          <tr>
          ...
          <tr>
            <td data-column="Car Make">BMW</td>
            <td data-column="Average Price">£70.21</td>
            <td data-column="Get Quotes"><button class="btn btn-success rqBtn" style="background-color: #4dbb0d;">Compare Quotes</button></td>
                   </tr>
          <tr>
          ...
          <tr>
            <td data-column="Car Make">Mercedes</td>
            <td data-column="Average Price">£62.34</td>
            <td data-column="Get Quotes"><button class="btn btn-success rqBtn" style="background-color: #4dbb0d;">Compare Quotes</button></td>
                   </tr>
                   <tr>
            ...
            <td data-column="Get Quotes"><button class="btn btn-success rqBtn" style="background-color: #4dbb0d;">Compare Quotes</button></td>
                   ...
                   <tr>
            <td data-column="Car Make">Audi</td>
            ...
            <td data-column="Get Quotes"><button class="btn btn-success rqBtn" style="background-color: #4dbb0d;">Compare Quotes</button></td>
                   ...
                   <tr>
            <td data-column="Car Make">Nissan</td>
            <td data-column="Average Price">£80.26</td>
            <td data-column="Get Quotes"><button class="btn btn-success rqBtn" style="background-color: #4dbb0d;">Compare Quotes</button></td>
                   </tr>
                   <tr>
      ...
      <p>This table uses data from quotes provided on abc.com between 03/03/2021 and 01/06/2021.</p>
      <br>
...
<div class="tab-content">
	...
	<div class="tab-pane active" id="tabs-1" role="tabpanel">
        ...
        <div class="row" style="font-size: 14px;">
            <div class="col-12 col-sm-12 col-md-3">
                <a href="LocLondon.html" style="color: #00b81f;">Mobile Mechanic in Leeds</a><br><br>
            </div>
            <div class="col-12 col-sm-12 col-md-3">
                <a href="LocLondon.html" style="color: #00b81f;">Mobile Mechanic in Newcastle </a><br><br>
            </div>
            <div class="col-12 col-sm-12 col-md-3">
                <a href="LocLondon.html" style="color: #00b81f;">Mobile Mechanic in Manchester</a><br><br>
            </div>
            <div class="col-12 col-sm-12 col-md-3">
                <a href="LocLondon.html" style="color: #00b81f;">Mobile Mechanic in Birmingham</a><br><br>
            </div>
        </div>
        <div class="row"style="font-size: 14px;">
            <div class="col-12 col-sm-12 col-md-3">
            ...
            <div class="col-12 col-sm-12 col-md-3">
                <a href="LocLondon.html" style="color: #00b81f;">Mobile Mechanic in Cardiff</a><br><br>
            </div>
            <div class="col-12 col-sm-12 col-md-3">
                <a href="LocLondon.html" style="color: #00b81f;">Mobile Mechanic in Glasgow</a><br><br>
            </div>
            <div class="col-12 col-sm-12 col-md-3">
                <a href="LocLondon.html" style="color: #00b81f;">Mobile Mechanic in Liverpool</a><br><br>
            </div>
        </div>
        <div class="row"style="font-size: 14px;">
            <div class="col-12 col-sm-12 col-md-3">
                <a href="LocLondon.html" style="color: #00b81f;">Mobile Mechanic in Coventry</a><br><br>
            </div>
            <div class="col-12 col-sm-12 col-md-3">
                <a href="LocLondon.html" style="color: #00b81f;">Mobile Mechanic in Derby</a><br><br>
            </div>
            <div class="col-12 col-sm-12 col-md-3">
                <a href="LocLondon.html" style="color: #00b81f;">Mobile Mechanic in Nottingham</a><br><br>
            </div>
            <div class="col-12 col-sm-12 col-md-3">
                <a href="LocLondon.html" style="color: #00b81f;">Mobile Mechanic in Edinburgh</a><br><br>
            </div>
        </div>
        <div class="row"style="font-size: 14px;">
            <div class="col-12 col-sm-12 col-md-3">
                <a href="LocLondon.html" style="color: #00b81f;">Mobile Mechanic in Belfast</a><br><br>
            </div>
            <div class="col-12 col-sm-12 col-md-3">
                <a href="LocLondon.html" style="color: #00b81f;">Mobile Mechanic in Bristol</a><br><br>
            </div>
            <div class="col-12 col-sm-12 col-md-3">
                <a href="LocLondon.html" style="color: #00b81f;">Mobile Mechanic in Oxford</a><br><br>
            </div>
            <div class="col-12 col-sm-12 col-md-3">
                <a href="LocLondon.html" style="color: #00b81f;">Mobile Mechanic in Leicester</a><br><br>
            </div>
        </div>
	</div>
	<div class="tab-pane" id="tabs-2" role="tabpanel">
        ...
        <div class="row" style="font-size: 14px;">
            ...
            <div class="col-12 col-sm-12 col-md-3">
                <a href="topCompany.html" style="color: #00b81f;">Vauxhall Mobile Mechanic</a><br><br>
            </div>
            <div class="col-12 col-sm-12 col-md-3">
                <a href="topCompany.html" style="color: #00b81f;">Ford Mobile Mechanic
                </a><br><br>
            </div>
            <div class="col-12 col-sm-12 col-md-3">
                <a href="topCompany.html" style="color: #00b81f;">Volkswagen Mobile Mechanic
                </a><br><br>
            </div>
            <div class="col-12 col-sm-12 col-md-3">
                <a href="topCompany.html" style="color: #00b81f;">BMW Mobile Mechanic
                </a><br><br>
            </div>
        </div>
        <div class="row"style="font-size: 14px;">
            ...
            <div class="col-12 col-sm-12 col-md-3">
                <a href="topCompany.html" style="color: #00b81f;">Audi Mobile Mechanic</a><br><br>
            </div>
            <div class="col-12 col-sm-12 col-md-3">
               <a href="topCompany.html" style="color: #00b81f;">Peugeot Mobile Mechanic</a><br><br>
            </div>
            <div class="col-12 col-sm-12 col-md-3">
                <a href="topCompany.html" style="color: #00b81f;">Mercedes Mobile Mechanic</a><br><br>
            </div>
            <div class="col-12 col-sm-12 col-md-3">
                <a href="topCompany.html" style="color: #00b81f;">Renault Mobile Mechanic</a><br><br>
            </div>
        </div>
        <div class="row"style="font-size: 14px;">            
            
            <div class="col-12 col-sm-12 col-md-3">
                <a href="topCompany.html" style="color: #00b81f;">Nissan Mobile Mechanic</a><br><br>
            </div>
            <div class="col-12 col-sm-12 col-md-3">
                <a href="topCompany.html" style="color: #00b81f;">Citroen Mobile Mechanic</a><br><br>
            </div>
            <div class="col-12 col-sm-12 col-md-3">
                <a href="topCompany.html" style="color: #00b81f;">Toyota Mobile Mechanic</a><br><br>
            </div>
            <div class="col-12 col-sm-12 col-md-3">
                <a href="topCompany.html" style="color: #00b81f;">Honda Mobile Mechanic</a><br><br>
            </div>
        </div>
        <div class="row"style="font-size: 14px;">
           ...
           <div class="col-12 col-sm-12 col-md-3">
                <a href="topCompany.html" style="color: #00b81f;">  MINI Mobile Mechanic</a><br><br>
            </div>
            <div class="col-12 col-sm-12 col-md-3">
                <a href="topCompany.html" style="color: #00b81f;">Fiat Mobile Mechanic</a><br><br>
            </div>
            <div class="col-12 col-sm-12 col-md-3">
                <a href="topCompany.html" style="color: #00b81f;">Hyundai Mobile Mechanic</a><br><br>
            </div>
            <div class="col-12 col-sm-12 col-md-3">
                <a href="topCompany.html" style="color: #00b81f;">SEAT Mobile Mechanic</a><br><br>
            </div>
        </div>
        <div class="row"style="font-size: 14px;">
            
            <div class="col-12 col-sm-12 col-md-3">
                 <a href="topCompany.html" style="color: #00b81f;"> Land Rover Mobile Mechanic</a><br><br>
             </div>
             <div class="col-12 col-sm-12 col-md-3">
                 <a href="topCompany.html" style="color: #00b81f;">Skoda Mobile Mechanic</a><br><br>
             </div>
             <div class="col-12 col-sm-12 col-md-3">
                 <a href="topCompany.html" style="color: #00b81f;">Kia Mobile Mechanic</a><br><br>
             </div>
             <div class="col-12 col-sm-12 col-md-3">
                 <a href="topCompany.html" style="color: #00b81f;">Mazda Mobile Mechanic</a><br><br>
             </div>
         </div>
	</div>
	<div class="tab-pane" id="tabs-3" role="tabpanel">
        ...
        <div class="row" style="font-size: 14px;">
            <div class="col-12 col-sm-12 col-md-3">
                <a href="allService.html" style="color: #00b81f;">Full Service</a><br><br>
            </div>
            <div class="col-12 col-sm-12 col-md-3">
                <a href="allService.html" style="color: #00b81f;">Clutch Replacement</a><br><br>
            </div>
            <div class="col-12 col-sm-12 col-md-3">
                <a href="allService.html" style="color: #00b81f;">MOT</a><br><br>
            </div>
            <div class="col-12 col-sm-12 col-md-3">
                <a href="allService.html" style="color: #00b81f;">Full Service and MOT</a><br><br>
            </div>
        </div>
        <div class="row"style="font-size: 14px;">
            <div class="col-12 col-sm-12 col-md-3">
                <a href="allService.html" style="color: #00b81f;">Oil Change</a><br><br>
            </div>
            <div class="col-12 col-sm-12 col-md-3">
               <a href="allService.html" style="color: #00b81f;">Aircon Regas</a><br><br>
            </div>
            <div class="col-12 col-sm-12 col-md-3">
                <a href="allService.html" style="color: #00b81f;">Interim Service</a><br><br>
            </div>
            <div class="col-12 col-sm-12 col-md-3">
                <a href="allService.html" style="color: #00b81f;">Timing Chain</a><br><br>
            </div>
        </div>
        <div class="row"style="font-size: 14px;">
            ...
            <div class="col-12 col-sm-12 col-md-3">
                <a href="allService.html" style="color: #00b81f;">Puncture Repair</a><br><br>
            </div>
            <div class="col-12 col-sm-12 col-md-3">
                <a href="allService.html" style="color: #00b81f;">Windscreen Replacement</a><br><br>
            </div>
            <div class="col-12 col-sm-12 col-md-3">
                <a href="allService.html" style="color: #00b81f;">Alternator Repair</a><br><br>
            </div>
            <div class="col-12 col-sm-12 col-md-3">
                <a href="allService.html" style="color: #00b81f;">Exhaust Repair</a><br><br>
            </div>
        </div>
        <div class="row"style="font-size: 14px;">
            
           <div class="col-12 col-sm-12 col-md-3">
                <a href="allService.html" style="color: #00b81f;">Diesel Particulate Filter Clean</a><br><br>
            </div>
            <div class="col-12 col-sm-12 col-md-3">
                <a href="allService.html" style="color: #00b81f;">Electrical Faults</a><br><br>
            </div>
            <div class="col-12 col-sm-12 col-md-3">
                <a href="allService.html" style="color: #00b81f;">Front Wheel Alignment</a><br><br>
            </div>
            <div class="col-12 col-sm-12 col-md-3">
                <a href="allService.html" style="color: #00b81f;">Turbo Faults and Replacement</a><br><br>
            </div>
        </div>
        <div class="row"style="font-size: 14px;">
            <div class="col-12 col-sm-12 col-md-3">
                 <a href="allService.html" style="color: #00b81f;"> Parking Sensors</a><br><br>
             </div>
             <div class="col-12 col-sm-12 col-md-3">
                 <a href="allService.html" style="color: #00b81f;">Interim Service and MOT</a><br><br>
             </div>
             <div class="col-12 col-sm-12 col-md-3">
                 <a href="allService.html" style="color: #00b81f;">Shock Absorber Repair</a><br><br>
             </div>
             <div class="col-12 col-sm-12 col-md-3">
                 <a href="allService.html" style="color: #00b81f;">Pre-Purchase Car Inspection</a><br><br>
             </div>
         </div>
    </div>
