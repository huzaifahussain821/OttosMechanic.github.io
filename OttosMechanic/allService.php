...
<div class="container" style="text-align: center; padding: 2%">
    ...
    <br>
    <h2>Most common repairs and services</h2>
    <br><br>
    <div class="container-fluid">
        <div class="row" style="padding: 10px;">
            <div class="col-md-3 col-12 col-sm-12 plo">
                <div class="row">
                    <div class="col-12 col-sm-12 col-md-4">
                        <img src="imgs/AllService/mobile-mechanic.svg" class="cImg"  style="width: 40px;">
                    </div>
                    <div class="col-12 col-sm-12 col-md-8" style="text-align: left;">
                        <a href="mobileMechanic.php" style="color: black;">
            ...
            <div class="col-md-3 col-12 col-sm-12 plo" >
                <div class="row">
                    <div class="col-12 col-sm-12 col-md-4">
                        <img src="imgs/AllService/full-service-icon.svg" class="cImg"   style="width: 40px;">
                    </div>
                    <div class="col-12 col-sm-12 col-md-8" style="text-align: left;">
                       <a href="fullService.php" style="color: black;">
                        <h5> Full Service</h5>
 </a>                   </div>
                </div>
            </div>
            <div class="col-md-3 col-12 col-sm-12 plo" >
                <div class="row">
                    <div class="col-12 col-sm-12 col-md-4">
                        <img src="imgs/AllService/exhaust-fitting.svg" class="cImg"   style="width: 40px;">
                    </div>
                    <div class="col-12 col-sm-12 col-md-8" style="text-align: left;">
                       <a href="ExhaustFitting.php" style="color: black;">
                        <h5> Exhaust Fitting</h5>
 </a>                   </div>
                </div>
            </div>
            <div class="col-md-3 col-12 col-sm-12 plo" >
                <div class="row">
                    <div class="col-12 col-sm-12 col-md-4">
                        <img src="imgs/AllService/clutch-and-gearbox.svg" class="cImg"   style="width: 40px;">
                    </div>
                    <div class="col-12 col-sm-12 col-md-8" style="text-align: left;">
                       <a href="clutchReplacement.php" style="color: black;">
                        <h5> Clutch Replacement</h5>
 </a>                   </div>
                </div>
            </div>
        ...
        <div class="row"style="padding: 10px;">
            <div class="col-md-3 col-12 col-sm-12 plo" >
                <div class="row">
                    <div class="col-12 col-sm-12 col-md-4">
                        <img src="imgs/AllService/cambelt.svg" class="cImg"   style="width: 40px;">
                    </div>
                    <div class="col-12 col-sm-12 col-md-8" style="text-align: left;">
                       <a href="cambeltChange.php" style="color: black;">
                        <h5> Cambelt Change</h5>
 </a>                   </div>
                </div>
            </div>
            <div class="col-md-3 col-12 col-sm-12 plo" >
                <div class="row">
                    <div class="col-12 col-sm-12 col-md-4">
                        <img src="imgs/AllService/oil-change.svg" class="cImg" style="width: 30px;" >
                    </div>
                    <div class="col-12 col-sm-12 col-md-8" style="text-align: left;">
                       <a href="OilChnage.php" style="color: black;">
                        <h5> Oil Change</h5>
 </a>                   </div>
                </div>
            </div>
            <div class="col-md-3 col-12 col-sm-12 plo" >
                <div class="row">
                    <div class="col-12 col-sm-12 col-md-4">
                        <img src="imgs/AllService/bodywork-dents.svg" class="cImg"   style="width: 30px;">
                    </div>
                    <div class="col-12 col-sm-12 col-md-8" style="text-align: left;">
                       <a href="bodyWork.php" style="color: black;">
                        <h5> Body Works, Dents and smart repairs</h5>
 </a>                   </div>
                </div>
            </div>
            <div class="col-md-3 col-12 col-sm-12 plo" >
                <div class="row">
                    <div class="col-12 col-sm-12 col-md-4">
                        <img src="imgs/AllService/windows.svg" class="cImg"   style="width: 40px;">
                    </div>
                    <div class="col-12 col-sm-12 col-md-8" style="text-align: left;">
                       <a href="wingMirror.php" style="color: black;">
                        <h5> Wing Mirror</h5>
 </a>                   </div>
                </div>
            </div>
        ...
        <div class="row"style="padding: 10px;">
            <div class="col-md-3 col-12 col-sm-12 plo" >
                <div class="row">
                    <div class="col-12 col-sm-12 col-md-4">
                        <img src="imgs/AllService/brake-pads-discs.svg" class="cImg"  style="width: 40px;" >
                    </div>
                    <div class="col-12 col-sm-12 col-md-8" style="text-align: left;">
                       <a href="brake&Disc.php" style="color: black;">
                        <h5>Brake Pads & Discs</h5>
 </a>                   </div>
                </div>
            </div>
            <div class="col-md-3 col-12 col-sm-12 plo" >
                <div class="row">
                    ...
                    <div class="col-12 col-sm-12 col-md-8" style="text-align: left;">
                       <a href="MobileTyreFitting.php" style="color: black;">
                        <h5> Mobile Tyre Fitting</h5>
 </a>                   </div>
                </div>
            </div>
            <div class="col-md-3 col-12 col-sm-12 plo" >
                <div class="row">
                    <div class="col-12 col-sm-12 col-md-4">
                        <img src="imgs/AllService/mot-icon.svg" class="cImg"   style="width: 40px;">
                    </div>
                    <div class="col-12 col-sm-12 col-md-8" style="text-align: left;">
                       <a href="MOT.php" style="color: black;">
                        <h5>MOT</h5>
 </a>                   </div>
                </div>
            </div>
            <div class="col-md-3 col-12 col-sm-12 plo" >
                <div class="row">
                    ...
                    <div class="col-12 col-sm-12 col-md-8" style="text-align: left;">
                       <a href="FullService&MOT.php" style="color: black;">
                        <h5>Full Service & MOT</h5>
 </a>                   </div>
                </div>
            </div>
        ...
        <div class="row"style="padding: 10px;">
            <div class="col-md-3 col-12 col-sm-12 plo" >
                <div class="row">
                    <div class="col-12 col-sm-12 col-md-4">
                        <img src="imgs/AllService/icon-steering.svg" class="cImg"   style="width: 40px;">
                    </div>
                    <div class="col-12 col-sm-12 col-md-8" style="text-align: left;">
                        <a href="Aircon.php" style="color: black;">
                         <h5>Aircon</h5>
  </a>                   </div>
            ...
            <div class="col-md-3 col-12 col-sm-12 plo" >
                <div class="row">
                    <div class="col-12 col-sm-12 col-md-4">
                        <img src="imgs/AllService/icon-engineCooling.svg" class="cImg"  style="width: 40px;" >
                    </div>
                    <div class="col-12 col-sm-12 col-md-8" style="text-align: left;">
                       <a href="shockAbsorber.php" style="color: black;">
                        <h5> Shock Absorber Repair</h5>
 </a>                   </div>
                </div>
            </div>
            <div class="col-md-3 col-12 col-sm-12 plo" >
                <div class="row">
                    <div class="col-12 col-sm-12 col-md-4">
                        <img src="imgs/AllService/icon-battery.svg" class="cImg"   style="width: 40px;">
                    </div>
                    <div class="col-12 col-sm-12 col-md-8" style="text-align: left;">
                       <a href="AlternateRepair.php" style="color: black;">
                        <h5> Alternate Repair</h5>
 </a>                   </div>
                </div>
            </div>
            <div class="col-md-3 col-12 col-sm-12 plo" >
                <div class="row">
                    ...
                    <div class="col-12 col-sm-12 col-md-8" style="text-align: left;">
                       <a href="electricalFault.php" style="color: black;">
        ...
        <div class="row"style="padding: 10px;">
            <div class="col-md-3 col-12 col-sm-12 plo" >
                <div class="row">
                    <div class="col-12 col-sm-12 col-md-4">
                        <img src="imgs/AllService/icon-heatingCooling.svg" class="cImg"  style="width: 40px;" >
                    </div>
                    <div class="col-12 col-sm-12 col-md-8" style="text-align: left;">
                       <a href="Diagnostic.php" style="color: black;">
                        <h5> Diagnostics</h5>
 </a>                   </div>
                </div>
            </div>
            <div class="col-md-3 col-12 col-sm-12 plo" >
                <div class="row">
                    ...
                    <div class="col-12 col-sm-12 col-md-8" style="text-align: left;">
                       <a href="turboFault.php" style="color: black;">
                        <h5> Turbo Faults & Replacement</h5>
 </a>                   </div>
                </div>
            </div>
